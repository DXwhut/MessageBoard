...
<label for="unum">验证码：</label><input name="unum" type="text" id="unum" size="10">* <img src="include/randnum.php?id=-1" title="点击刷新" style="cursor:pointer" onclick=eval('this.src="include/randnum.php?id='+i+++'"')><br />
...
// 			}
			...
			//还原结束
			$sql="insert into ".TABLE_PREFIX."message(username,email,content,userip,systime,ifshow,ifqqh)
		values('".$username."','".$email."','".$content."','".$userip."','".$systime."',".$ifshow.",".$ifqqh.")";
			//echo $sql;
				if(($db->insert($sql))>0){
					$_SESSION['timer']=time();
